/* Khama — Firebase client config
 *
 * Paste the firebaseConfig object you got from the Firebase console here.
 * These are PUBLIC keys — they're meant to be visible in client code, and
 ...
 * via a small build step or window.KHAMA_FIREBASE_CONFIG injection. For this
 * static no-build setup, putting them in this file is fine.
 */
window.KHAMA_FIREBASE_CONFIG = {
